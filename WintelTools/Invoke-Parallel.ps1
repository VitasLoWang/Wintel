                ...
                Do {
                    ...
                    Foreach($runspace in $runspaces) {
                        ...
                        ElseIf ( $runspaceTimeout -ne 0 -and $runtime.totalseconds -gt $runspaceTimeout) {
                            ...
                            log($runspace.object | out-string)
...
(
    ...
    Process {
         #[DateTime]::Now.ToString("yyyy/MM/dd-HH:mm:ss")+" "+$message|out-file ("c:\temp\TimedOutHostnames.txt") -append
         $message.trimend()|out-file ("c:\temp\TimedOutHostnames.txt") -append
    }
}
